  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      <Typography variant="body1">
        Right-click on the buttons above to see the context menus in action. Check the console for
        the actions that are triggered when you click on the menu items.
      </Typography>
