...
export const LogViewer = () => {
	...
	const loadLogs = useCallback(async () => {
		setLoading(true)
		try {
			const fetchedLogs = await loggerService.getLogs(filter || undefined, rowsPerPage * (page + 1))
		...
		<Box>
			...
			<Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
				<FormControl size="small" sx={{ minWidth: 120 }}>
					...
					<Select labelId="log-level-filter-label" value={filter} label="Level" onChange={handleFilterChange}>
