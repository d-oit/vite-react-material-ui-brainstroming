...
import { performanceTracker as performanceMonitoringUtil, PerformanceCategory } from '../utils/performanceTracker'
...
const PerformanceProfiler: React.FC<PerformanceProfilerProps> = ({ open: externalOpen, onClose }) => {
