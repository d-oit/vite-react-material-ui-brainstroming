...
import { Box, ButtonGroup, IconButton, Tooltip, Slider, Paper, Typography, useTheme, alpha } from '@mui/material'
			...
			<Paper
				...
				{onToggleMiniMap && (
					<Tooltip title={t('flow.toggleMiniMap') ?? 'Toggle Mini Map (Ctrl+M)'} placement="left">
						<IconButton onClick={onToggleMiniMap} size="small" color={showMiniMap ? 'primary' : 'default'}>
				...
				{/* Fullscreen Toggle */}
				{onToggleFullscreen && (
					<Tooltip title={t('flow.toggleFullscreen') ?? 'Toggle Fullscreen (Ctrl+Shift+F)'} placement="left">
						<IconButton
