...
export const EnhancedMiniMap: React.FC<EnhancedMiniMapProps> = ({
	...
	const defaultBackgroundColor = theme.palette.mode === 'dark' ? theme.palette.grey[900] : theme.palette.grey[100]

	const defaultBorderColor = theme.palette.divider

	const defaultMaskColor = theme.palette.mode === 'dark' ? 'rgba(0, 0, 0, 0.6)' : 'rgba(255, 255, 255, 0.6)'

	const defaultNodeStrokeColor = theme.palette.mode === 'dark' ? theme.palette.grey[300] : theme.palette.grey[700]
