...
export const NodeStyleDialog: React.FC<NodeStyleDialogProps> = ({ open, onClose, node, onSave }) => {
	const { t } = useI18n()
				...
				<Grid container spacing={3}>
					...
					<Grid item size={{ xs: 12, md: 6 }}>
						...
						<FormControl fullWidth margin="normal">
							<InputLabel id="font-family-label">{t('flow.fontFamily') ?? 'Font Family'}</InputLabel>
							<Select
