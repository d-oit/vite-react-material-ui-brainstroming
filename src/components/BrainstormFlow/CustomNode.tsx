	...
	return (
		<Card
			...
			<Box
				...
				<Box>
					<IconButton size="small" onClick={() => data.onEdit?.(id)} aria-label="Edit node" title="Edit node">
			...
			<CardContent sx={{ p: nodeSize.padding }}>
				...
				<Typography
					...
					{shouldCollapseContent ? `${data.content.substring(0, 100)}... (tap to expand)` : data.content}
				</Typography>
			</CardContent>
