...
const NodeEditDialog = ({ open, onClose, onSave, initialData, initialType = NodeType.IDEA }: NodeEditDialogProps) => {
					...
					<Box
						...
						<Box
							sx={{
								...
								p: 1,
								boxShadow: 1,
								fontSize: nodePreferences ? `${nodePreferences.nodeSizes[size].fontSize}rem` : '1rem',
							}}>
							<Typography
								variant="subtitle2"
								sx={{
