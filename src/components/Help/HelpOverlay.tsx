            ...
            <>
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                <Paper sx={{ p: 2, flex: '1 1 45%', minWidth: 250 }}>
                  ...
                  <List dense>
                    <ListItem>
                      <ListItemText primary={t('shortcuts.save') || 'Save'} secondary="Ctrl + S" />
                    </ListItem>
                    <ListItem>
                      <ListItemText primary={t('shortcuts.undo') || 'Undo'} secondary="Ctrl + Z" />
                    </ListItem>
                    <ListItem>
                      <ListItemText primary={t('shortcuts.redo') || 'Redo'} secondary="Ctrl + Y" />
                    </ListItem>
                    <ListItem>
                      <ListItemText
                ...
                <Paper sx={{ p: 2, flex: '1 1 45%', minWidth: 250 }}>
                  ...
                  <List dense>
                    ...
                    <ListItem>
                      <ListItemText primary={t('shortcuts.copy') || 'Copy'} secondary="Ctrl + C" />
                    </ListItem>
                    <ListItem>
                      <ListItemText
