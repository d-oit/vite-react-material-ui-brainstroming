import { Language as LanguageIcon, Check as CheckIcon, Search as SearchIcon } from '@mui/icons-material'
import {
	Box,
	Button,
	Dialog,
...
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({
	...
	const languageDialog = (
		<Dialog
			...
			<DialogTitle id="language-dialog-title">{t('language.select') || 'Select Language'}</DialogTitle>
