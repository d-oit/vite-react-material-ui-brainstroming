...
export const AddToBrainstormButton: React.FC<AddToBrainstormButtonProps> = ({
  messageContent,
  onAddToCanvas,
}) => {
  const { t } = useI18n();
    ...
    <>
      <Tooltip title={t('chat.addToCanvas') || 'Add to canvas'}>
        <IconButton
          size="small"
          onClick={handleClick}
          aria-label={t('chat.addToCanvas') || 'Add to canvas'}
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, mt: 1 }}>
            ...
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value={NodeType.RESOURCE}>
                  {t('nodeTypes.resource') || 'Resource'}
                </MenuItem>
              </Select>
            </FormControl>
          </Box>
