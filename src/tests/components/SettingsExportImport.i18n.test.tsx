...
describe('SettingsExportImport i18n', () => {
	...
	it('renders with French translations', () => {
		...
		expect(
			screen.getByText('Exportez vos paramètres vers un fichier ou importez des paramètres depuis un fichier.'),
		).toBeInTheDocument()
	...
	it('renders with Spanish translations', () => {
		...
		expect(
			screen.getByText('Exporte su configuración a un archivo o importe configuración desde un archivo.'),
		).toBeInTheDocument()
