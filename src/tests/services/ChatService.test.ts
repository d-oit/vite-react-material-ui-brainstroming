...
describe('ChatService', () => {
	...
	describe('sendMessage', () => {
		it('should throw an error if not configured', async () => {
			...
			await expect(unconfiguredService.sendMessage([])).rejects.toThrow('ChatService is not configured')
		})
	...
	describe('generateNodeSuggestions', () => {
		...
		it('should handle invalid response structure', async () => {
			...
			await expect(chatService.generateNodeSuggestions(prompt)).rejects.toThrow('Invalid response format')
		})
	})
	...
	describe('getAvailableModels', () => {
		it('should throw an error if not configured', async () => {
			...
			await expect(unconfiguredService.getAvailableModels()).rejects.toThrow('ChatService is not configured')
		})
		...
		it('should handle API errors', async () => {
			mockFetch.mockImplementationOnce(() => createMockResponse({ error: { message: 'Invalid API key' } }, false))
