...
test.describe('Chat Panel Improvements', () => {
  ...
  test('should have proper header and footer that stay fixed during scrolling', async ({ page }) => {
    // Verify chat header is visible
    const chatHeader = page.locator('div').filter({ hasText: /chat title/i }).first();
    ...
    const chatFooter = page.locator('div').filter({ hasText: /type a message/i }).first();
  ...
  test('should have proper message styling and layout', async ({ page }) => {
    ...
    const userMessageContainer = userMessage.locator('xpath=ancestor::div[contains(@class, "MuiPaper-root")]');
    ...
    if (userMessageBox) {
      ...
      const chatPanelWidth = await page.locator('div').filter({ hasText: /chat title/i }).first().evaluate((el) => {
    ...
    const botMessageContainer = botMessage.locator('xpath=ancestor::div[contains(@class, "MuiPaper-root")]');
  ...
  test('should handle chat panel opening and closing smoothly', async ({ page }) => {
    ...
    const chatPanel = page.locator('div').filter({ hasText: /chat title/i }).first();
