...
test.describe('UI Improvements', () => {
  ...
  test('should have proper layout structure with no overlapping elements', async ({ page }) => {
    ...
    const toolbar = page.locator('.react-flow').locator('div').filter({ hasText: /zoom in/i }).first();
  ...
  test('should have properly positioned toolbar with working controls', async ({ page }) => {
    ...
    const toolbar = page.locator('div').filter({ hasText: /zoom in/i }).first();
    await expect(toolbar).toBeVisible();
  ...
  test('should be responsive on mobile devices', async ({ page }) => {
    ...
    const mobileControls = page.locator('div').filter({ hasText: /zoom in/i }).first();
