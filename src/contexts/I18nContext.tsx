...
const translations: Record<string, Translations> = {
  en: {
    ...
    'chat.openChat': 'Open AI Chat Assistant',
    ...
    'brainstorm.confirmDeleteMessage':
  ...
  de: {
    ...
    'chat.offlineWarning':
      'Sie sind derzeit offline. Die Chat-Funktionalität ist erst wieder verfügbar, wenn Sie wieder online sind.',
    ...
    'chat.generateNodesError':
      'Beim Generieren von Knoten ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
    ...
    'chat.openChat': 'KI-Chat-Assistent öffnen',
    'chat.poweredBy': 'Unterstützt von',
    ...
    'brainstorm.confirmDeleteMessage':
      'Sind Sie sicher, dass Sie diesen Knoten löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.',
