...
export const translations = {
	...
	brainstorm: {
		...
		settings: 'Einstellungen',
		canvasContextMenu: 'Leinwand-Kontextmenü',
		addIdeaNode: 'Ideen-Knoten hinzufügen',
		addTaskNode: 'Aufgaben-Knoten hinzufügen',
		addNoteNode: 'Notiz-Knoten hinzufügen',
		addResourceNode: 'Ressourcen-Knoten hinzufügen',
