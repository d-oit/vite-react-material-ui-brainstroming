...
export const translations = {
	...
	brainstorm: {
		...
		settings: 'Configuración',
		canvasContextMenu: 'Menú contextual del lienzo',
		addIdeaNode: 'Añadir nodo de idea',
		addTaskNode: 'Añadir nodo de tarea',
		addNoteNode: 'Añadir nodo de nota',
		addResourceNode: 'Añadir nodo de recurso',
		addIdea: 'Añadir Idea',
