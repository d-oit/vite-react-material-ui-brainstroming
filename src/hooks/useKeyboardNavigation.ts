...
export const useKeyboardNavigation = (
	...
	const updateNodeSelection = useCallback(
		(nodeElement: NodeElement) => {
			...
			const title =
				typeof nodeElement.dataset.nodeTitle === 'string' ? nodeElement.dataset.nodeTitle : 'Untitled node'
			const type =
				typeof nodeElement.dataset.nodeType === 'string' ? nodeElement.dataset.nodeType : 'unknown type'
