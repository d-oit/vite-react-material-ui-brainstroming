...
import ReactFlow, { addEdge, Background, Controls, MarkerType, Position, useEdgesState, useNodesState } from 'reactflow'
...
export default function ComprehensiveBrainstorm({ projectId, session, onSave, onClose }: BrainstormingProps) {
	const { t } = useI18n()
		...
		<Paper
			...
			<Stack
				...
				<Tooltip title={t('common.redo')}>
					<IconButton onClick={handleRedo} disabled={historyIndex >= history.length - 1} size="small">
						<RedoIcon />
					</IconButton>
				</Tooltip>
